...
export default function BlogClient() {
  ...
  const categoryKeywords: Record<string, string[]> = {
    all: [],
    strategy: ['strategy', 'estrategia', 'roadmap'],
    design: ['design', 'diseño', 'ux', 'ui', 'web'],
    marketing: ['marketing', 'automation', 'growth', 'brand', 'contenido'],
    tech: ['tech', 'tecnologia', 'seo', 'analytics', 'data'],
  };
  ...
  const filteredPosts = otherPosts.filter((post) => {
    ...
    const matchesCategory =
      ...
      (categoryKeywords[selectedCategory] || []).some((keyword) => normalize(post.category).includes(normalize(keyword)));
