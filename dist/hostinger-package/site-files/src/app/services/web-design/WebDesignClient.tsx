  ...
  es: {
    ...
    caseStudy: {
      ...
      data: {
        ...
        testimonial: {
          quote:
            "CreamosTech no solo rediseñó nuestro sitio web, transformaron cómo nuestros clientes nos perciben. Las conversiones hablan por sí solas.",
          author: "María García",
  ...
  en: {
    ...
    caseStudy: {
      ...
      data: {
        ...
        testimonial: {
          quote:
            "CreamosTech didn't just redesign our site—they transformed how customers perceive us. The conversions speak for themselves.",
          author: "Maria Garcia",
          role: "CEO, CloudSync Solutions",
        },
      },
