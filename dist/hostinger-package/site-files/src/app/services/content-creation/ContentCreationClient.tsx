  ...
  es: {
    ...
    caseStudy: {
      ...
      data: {
        ...
        testimonial: {
          quote:
            "CreamosTech entendió nuestra marca mejor que nosotros mismos. El contenido que crean se ve increíble y genera resultados reales.",
  ...
  en: {
    ...
    caseStudy: {
      ...
      data: {
        ...
        testimonial: {
          quote:
            "CreamosTech understood our brand better than we did. The content looks incredible and delivers real results.",
          author: "Andrea Villarreal",
