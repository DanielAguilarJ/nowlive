...
export default function OpenGraphImage() {
  return new ImageResponse(
    (
      ...
      >
        <div style={{ fontSize: 20, letterSpacing: 6, fontWeight: 700, color: '#6B7280' }}>CreamosTech</div>
        ...
        <div style={{ marginTop: 50, fontSize: 18, color: '#6B7280' }}>creamostech.agency</div>
      </div>
    ),
    {
      ...size,
