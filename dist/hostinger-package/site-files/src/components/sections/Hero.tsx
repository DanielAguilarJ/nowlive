...
export function Hero() {
  ...
  return (
    ...
    >
      ...
      {/* Decorative SVG shapes con efectos holográficos */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <svg
          className="absolute top-20 left-10 w-24 h-24 text-accent-500/30 animate-spin-slow holographic"
          viewBox="0 0 100 100"
        >
          <polygon points="50,5 95,75 5,75" fill="currentColor" />
        </svg>
        <svg
          className="absolute bottom-32 right-20 w-32 h-32 text-accent-400/30 animate-blob"
          viewBox="0 0 100 100"
        >
          <rect x="10" y="10" width="80" height="80" rx="10" fill="currentColor" />
        </svg>
        <svg
          className="absolute top-1/3 right-10 w-20 h-20 text-success-500/30 animate-float morph"
          viewBox="0 0 100 100"
        >
