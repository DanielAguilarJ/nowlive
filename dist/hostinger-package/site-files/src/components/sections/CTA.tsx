          ...
          >
            ...
            <div className="space-y-4">
              ...
              <button
                ...
                disabled={isSubmitting}
                className={`w-full p-6 rounded-xl border-2 transition-all duration-300 text-left group hover:shadow-lg ${selectedOption === 'audit'
              ...
              >
                <div className="flex items-start justify-between">
                  ...
                  <svg
                    className={`w-6 h-6 transition-transform duration-300 ${selectedOption === 'audit' ? 'text-accent-500' : 'text-gray-300 group-hover:text-accent-400'
                      }`}
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
              ...
              <button
                ...
                disabled={isSubmitting}
                className={`w-full p-6 rounded-xl border-2 transition-all duration-300 text-left group hover:shadow-lg ${selectedOption === 'quote'
              ...
              >
                <div className="flex items-start justify-between">
                  ...
                  <svg
                    className={`w-6 h-6 transition-transform duration-300 ${selectedOption === 'quote' ? 'text-primary-600' : 'text-gray-300 group-hover:text-primary-400'
                      }`}
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
