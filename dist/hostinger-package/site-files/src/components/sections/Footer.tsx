...
const socialLinks = [
  { icon: TwitterIcon, href: 'https://twitter.com/creamostech', label: 'Twitter' },
  { icon: LinkedInIcon, href: 'https://linkedin.com/company/creamostech', label: 'LinkedIn' },
  { icon: InstagramIcon, href: 'https://instagram.com/creamostech', label: 'Instagram' },
  { icon: FacebookIcon, href: 'https://facebook.com/creamostech', label: 'Facebook' },
];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-500 text-sm">
              © {new Date().getFullYear()} CreamosTech. {t.footer.bottom}
            </p>
