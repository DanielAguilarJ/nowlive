            ...
            >
              <Link href={service.href}>
                ...
                >
                  ...
                  <div
                    className={`absolute inset-0 bg-gradient-to-br from-red-50 to-orange-50 p-6 transition-all duration-500 ease-out ${hoveredCard === index
                  ...
                  <div
                    className={`transition-opacity duration-300 ${hoveredCard === index ? 'opacity-0' : 'opacity-100'
                      }`}
                  >
                    {/* Icon */}
                  ...
                  <div className="absolute top-4 right-4">
                    <div className={`transition-all duration-300 ${hoveredCard === index
