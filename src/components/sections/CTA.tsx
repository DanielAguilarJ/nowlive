...
export function CTA() {
  ...
  return (
    ...
    >
      {/* Static gradient background — zero JS, GPU-friendly */}
      <div
        className="absolute inset-0 -z-10"
        style={{
          background:
            'radial-gradient(ellipse 60% 50% at 20% 50%, rgba(99,102,241,0.45) 0%, transparent 70%), radial-gradient(ellipse 50% 50% at 80% 20%, rgba(139,92,246,0.35) 0%, transparent 70%), linear-gradient(135deg, #1e3a5f 0%, #2563eb 25%, #7c3aed 50%, #6366f1 75%, #0f172a 100%)',
        }}
      />
      ...
      <div ref={sectionRef} className="relative z-10 text-center">
        ...
        <ScrollReveal direction="up" delay={0.25}>
          <div className="inline-flex items-center gap-2 mb-10 px-3 py-2 sm:px-5 sm:py-2.5 rounded-full bg-amber-500/15 border border-amber-400/30 backdrop-blur-sm">
        ...
        <ScrollReveal direction="up" delay={0.4}>
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <div className="relative">
              {/* Animated ring — pure CSS */}
              <span
                className="absolute inset-0 rounded-xl border-2 border-white/50 pointer-events-none animate-ping"
                aria-hidden="true"
              />
              <Button
                variant="primary"
            ...
            >
              ...
              {lang === 'es' ? 'Chat por WhatsApp' : 'WhatsApp Chat'}
            </a>
          </div>
        </ScrollReveal>
      ...
      {showModal && (
        ...
        >
          <div
            className="relative bg-white rounded-3xl shadow-2xl max-w-lg w-full mx-auto max-h-[90vh] overflow-y-auto animate-modal-in"
