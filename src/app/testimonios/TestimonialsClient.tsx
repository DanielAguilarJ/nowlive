            ...
            {[1, 2, 3, 4, 5, 6].map((i) => (
              <div key={i} className="mx-6 w-[350px] bg-white/5 backdrop-blur-sm p-8 rounded-3xl border border-white/10">
                ...
                <p className="text-lg opacity-80 leading-relaxed">
                  {lang === 'es'
                    ? 'Increíble el trabajo de @CreamosTech. Han transformado nuestra presencia digital en tiempo récord.'
                    : 'Amazing work by @CreamosTech. They transformed our digital presence in record time.'}
                </p>
              </div>
            ))}
          </Marquee>
