...
export const translations = {
  es: {
    ...
    hero: {
      badge: "🔥 Sistema de Ventas Digital · Resultados en 14 días",
      headline: "Vende Millones al Día con tu",
      rotating: ["Web que convierte 24/7.", "Embudo de ventas automático.", "Marca que cobra premium.", "Sistema de Marketing 5x ROI."],
      subheadline:
        "Diseñamos, lanzamos y optimizamos sistemas de venta que generan millones de pesos al día para empresas como la tuya. Sin contratos largos. Garantía 5x ROI o te devolvemos cada peso.",
      primaryCTA: "Quiero vender millones",
      secondaryCTA: "Ver paquetes y precios",
      scrollLabel: "Mira los planes",
      stats: [
        { value: 287, suffix: "M+", label: "Pesos generados a clientes" },
        { value: 98, suffix: "%", label: "Clientes que renuevan" },
        { value: 14, suffix: " días", label: "Para tu primer cliente" },
        { value: 5, suffix: "x", label: "ROI promedio garantizado" },
      ],
    },
    services: {
    ...
    stats: {
      ...
      items: [
        ...
        { number: 1, suffix: "", label: "Miembro del Equipo", description: "Especialista SEO" },
    ...
    team: {
      badge: "Especialista SEO",
      title: "Conoce a tu especialista SEO",
      description:
        "Kevin Daniel Aguilar Junco, SEO en Aguascalientes, Mexico, enfocado en optimizacion, simulacion numerica y ML/AI para sistemas mecanicos y energeticos.",
      members: [
        {
          name: "Kevin Daniel Aguilar Junco",
          role: "SEO",
          bio: "Estudiante de Ingenieria en Energias Renovables (UAA) con enfoque en optimizacion, simulacion numerica y ML/AI aplicada a sistemas mecanicos y energeticos. Experiencia en colaboracion internacional de investigacion (University of South Bohemia, CZ).",
        },
      ],
    },
    testimonials: {
    ...
    cta: {
      badge: "🔥 Última oportunidad este mes · Solo 3 cupos disponibles",
      title: "Empieza a vender millones en los próximos 14 días",
      description:
        "Recibe en menos de 24h tu auditoría gratuita de $4,900 MXN + plan accionable para multiplicar tus ventas. Sin compromiso. Sin letra chiquita.",
      stats: [
        { value: 287, suffix: "M", label: "Revenue generado a clientes", prefix: "$" },
        { value: 98, suffix: "%", label: "Clientes que renuevan" },
        { value: 5, suffix: "x", label: "ROI promedio garantizado" },
        { value: 14, suffix: " días", label: "Para ver resultados" },
      ],
      primaryCTA: "Quiero vender millones ya",
      secondaryCTA: "Agendar llamada (15 min)",
    },
    footer: {
      description:
  ...
  en: {
    ...
    hero: {
      badge: "🔥 Digital Sales System · Results in 14 days",
      headline: "Sell Millions Every Day With Your",
      rotating: ["Website that converts 24/7.", "Automated sales funnel.", "Premium-priced brand.", "Marketing system at 5x ROI."],
      subheadline:
        "We design, launch, and optimize sales systems that generate millions for businesses like yours. No long contracts. 5x ROI guarantee or we refund every penny.",
      primaryCTA: "I want to sell millions",
      secondaryCTA: "See plans & pricing",
      scrollLabel: "See the plans",
      stats: [
        { value: 287, suffix: "M+", label: "Revenue generated for clients", prefix: "$" },
        { value: 98, suffix: "%", label: "Clients who renew" },
        { value: 14, suffix: " days", label: "To your first new client" },
        { value: 5, suffix: "x", label: "Guaranteed average ROI" },
      ],
    },
    services: {
      badge: "Our Services",
    ...
    stats: {
      ...
      items: [
        ...
        { number: 1, suffix: "", label: "Team Member", description: "SEO specialist" },
    ...
    team: {
      ...
      title: "Meet Your SEO Specialist",
      description:
        "Kevin Daniel Aguilar Junco, SEO based in Aguascalientes, Mexico, focused on optimization algorithms, numerical simulation, and ML/AI for mechanical and energy systems.",
      members: [
        {
          name: "Kevin Daniel Aguilar Junco",
          role: "SEO",
          bio: "Renewable Energy Engineering student at UAA focused on optimization algorithms, numerical simulation, and ML/AI for mechanical and energy systems. Experienced in international research collaboration (University of South Bohemia, CZ).",
        },
      ],
    },
    testimonials: {
    ...
    cta: {
      badge: "🔥 Last chance this month · Only 3 spots left",
      title: "Start selling millions in the next 14 days",
      description:
        "Get within 24h your free $290 USD audit + actionable plan to multiply your sales. No commitment. No fine print.",
      stats: [
        { value: 287, suffix: "M", label: "Revenue generated for clients", prefix: "$" },
        { value: 98, suffix: "%", label: "Clients who renew" },
        { value: 5, suffix: "x", label: "Guaranteed average ROI" },
        { value: 14, suffix: " days", label: "To see results" },
      ],
      primaryCTA: "I want to sell millions now",
      secondaryCTA: "Book a call (15 min)",
    },
    footer: {
      description:
